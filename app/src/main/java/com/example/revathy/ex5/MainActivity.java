package com.example.revathy.ex5;
...
public class MainActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            add.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if(empId.getText().toString().equals("")||name.getText().toString().equals("")||salary.getText().toString().equals(""))
                        ...
                        mydatabase.execSQL("INSERT INTO employee VALUES(" + id + ",'" + ename + "'," + esalary + ");");
